...
fully1=cnn3*11*11
#1 instr level 10 parameter pool2
fully1=cnn3*6*6

#1 instr level 10 parameter pool3
#fully1=cnn3*2*2
fully2=128
fully3=10
...
np.savetxt("resutls 2d 100 epoch train 10000 %s 43x43 1 instr level %d time2d 1 %d %d %d %d %d %d pool%d dropout %.2f lr %.4f.csv"%(device,level,cnn1,cnn2,cnn3,fully1,fully2,fully3,maxpool,1-keep_prob,learning_rate),combined_result, delimiter=',', fmt='%f')

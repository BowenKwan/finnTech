...
print("\n RUNNING TEST 333 for case 4\n")
print("\n", " python model.py --t 0 --qdata 3 --qweight 3 --qrelu 3 ".center(80, '#'), "\n")
os.system("python CNNmodel_case.py --t 0 --m 4 --qdata 3 --qweight 3 --qrelu 3")

print("\n", " python  transformation.py --f finn_QWNet2d.onnx ".center(80, '#'), "\n")
os.system("python transformation.py --f finn_QWNet2d_CNN_case4.onnx")
